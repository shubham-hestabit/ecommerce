        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered m-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="160">
                                <img src="{{ '/storage/product-images/' . $item->attributes->image }}" class="d-block"
                                    alt="" height=100 />
                            </td>
                            <td width="300">
                            ...
                            <td class="text-center align-middle p-4"><i class="fa fa-rupee"></i> {{ Cart::getTotal() }}
                            </td>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
                <div class="mt-4">
                    ...
                    <input type="text" placeholder="X387HW" class="form-control">
                </div>
                <div class="d-flex">
